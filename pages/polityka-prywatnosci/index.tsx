...
function Policy() {
  return (
    <>
      <NextSeo
        title='Polityka Prywatności - Krasińskiego29'
        description='Polityka prywatności biura COMTAX.'
        canonical='https://krasinskiego29.pl/polityka-prywatnosci/'
        noindex={true}
      />
          ...
          <section className={classNames('container', styles.policy)}>
            <ol>
              ...
              <li className='p-smaller'>
                ...
                <br />
                <br /> Przykładowe opcje edytowania w popularnych
                przeglądarkach:{' '}
                <ol>
                  <li>
                    Mozilla Firefox:{' '}
