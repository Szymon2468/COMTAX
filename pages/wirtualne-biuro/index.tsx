...
function VirtualOffice() {
  ...
  return (
    <>
      <NextSeo
        title='Wirtualne Biuro w Katowicach, Krasińskiego 29 - Śląsk'
        description='Sprawdzone Wirtualne Biuro pod adresem Krasińskiego 29 w Katowicach. Obsłużymy Twoją korespondencję. Nie szukaj dalej, skorzystaj z naszej oferty.'
        canonical='https://krasinskiego29.pl/wirtualne-biuro/'
      />
            ...
            <main className='container'>
              ...
              <p className={`smaller ${styles.offerInfo}`}>
                <strong>
                  ...
                  podpisanej na 12 miesięcy. Ceny przy krótszych współpracach
                  podano w porównaniu pakietów poniżej.
                </strong>
                <br /> <br />
                1) Sala konferencyjna/pokój spotkań biznesowych są dostępne 7
                dni w tygodniu po wcześniejszej rezerwacji. Wyposażenie sali
                konferencyjnej: stół, 6 krzeseł, flipchart, dostęp do
                bezprzewodowego Internetu, klimatyzacja, serwis kawowy.
                Stanowisko pracy jest dostępne w godzinach pracy biura.
                <br /> <br />
                2) Skanowaniu nie podlegają książki, materiały reklamowe i
                pozostałe w formacie innym niż pojedyncze kartki A4. Awers
                koperty liczony jest jako jedna strona.
              </p>
            </main>
          </section>
                      ...
                      .map((row) => (
                        <tr key={uuidv4()}>
                          ...
                          <td className={styles.comparisionColumn}>
                            <p
                              className={classNames('smaller', styles.iconCell)}
                            >
