        ...
        <section className={`${styles.offerSection}`}>
          ...
          <main className='container'>
            ...
            <p className={`smaller ${styles.offerInfo}`}>
              ...
              <br /> <br />
              1) Sala konferencyjna/pokój spotkań biznesowych są dostępne 7 dni
              w tygodniu po wcześniejszej rezerwacji. Wyposażenie sali
              ...
              pozostałe w formacie innym niż pojedyncze kartki A4. Awers koperty
              liczony jest jako jedna strona.
            </p>
          </main>
        </section>
